                    ...
                    <div className="w-full bg-gradient-to-t from-black via-black/70 to-transparent p-8">
                        <div className="max-w-7xl mx-auto">
                            <div className="flex justify-between items-end">
                                ...
                                {/* CTA Button */}
                                <button className="bg-white text-black px-8 py-4 rounded font-semibold hover:bg-gray-100 transition-all duration-300 border border-gray-300">
                                    VIEW PROPERTY
                                </button>
                            </div>
                        </div>
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center text-white z-10 px-4">
                        ...
                        <div className="flex justify-center mb-6">
                            <div className="flex bg-white rounded-lg overflow-hidden shadow-2xl max-w-2xl w-full">
                                <input
                                    type="text"
                                ...
                                />
                                <button className="bg-remax-blue text-white px-8 py-4 hover:bg-remax-dark-blue transition-colors duration-300">
                    ...
                    <div className="text-center max-w-4xl mx-auto">
                        ...
                        <div className="grid md:grid-cols-3 gap-8 mt-12">
                            <div className="text-center">
                                <div className="text-4xl font-bold text-remax-blue mb-2">110+</div>
                                <p className="text-gray-600">Countries & Territories</p>
                            </div>
                            <div className="text-center">
                                <div className="text-4xl font-bold text-remax-blue mb-2">140K+</div>
                                <p className="text-gray-600">Global Agents</p>
                            </div>
                            <div className="text-center">
                                <div className="text-4xl font-bold text-remax-blue mb-2">#1</div>
                                <p className="text-gray-600">Luxury Real Estate Brand</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div className="space-y-6">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600">Access to international buyers and sellers through our worldwide network</p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-4">
                                    <div className="flex-shrink-0 w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600">First access to off-market and pre-market luxury listings</p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-4">
                                    <div className="flex-shrink-0 w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center">
                                    ...
                                    <div>
                                        <h3 className="text-xl font-bold text-gray-900 mb-2">Expert Marketing</h3>
                                        <p className="text-gray-600">Sophisticated marketing strategies tailored for luxury properties</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <section className="py-20 bg-remax-blue text-white">
                <div className="max-w-4xl mx-auto text-center px-4">
                    ...
                    <p className="text-xl mb-10 leading-relaxed">
                        Connect with RE/MAX Collection agents who specialize in luxury real estate and deliver unparalleled service at every price point.
                    </p>
                    <div className="flex flex-wrap justify-center gap-4">
                        <button className="bg-white text-remax-blue px-8 py-4 rounded hover:bg-gray-100 transition-all duration-300 font-semibold text-lg">
                            FIND A LUXURY AGENT
                        </button>
                        <button className="border-2 border-white text-white px-8 py-4 rounded hover:bg-white hover:text-remax-blue transition-all duration-300 font-semibold text-lg">
